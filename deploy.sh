...
# ── StyloKey 빌드 & Google Drive 배포 스크립트 ──────────────────────────────

FLUTTER="/Users/gilzako/Downloads/flutter/bin/flutter"
PROJECT_DIR="/Users/gilzako/IdeaProjects/keyboard12345"
APK_DIR="$PROJECT_DIR/build/app/outputs/flutter-apk"
GDRIVE_FOLDER="StyloKey"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
APK_NAME="stylokey_${TIMESTAMP}.apk"
...
rclone copyto "$APK_DIR/app-release.apk" "gdrive:$GDRIVE_FOLDER/stylokey_latest.apk"

echo ""
echo "══════════════════════════════════════════"
echo "  ✅ 배포 완료!"
echo "  📁 gdrive:/$GDRIVE_FOLDER/$APK_NAME"
echo "  📁 gdrive:/$GDRIVE_FOLDER/stylokey_latest.apk"
echo "══════════════════════════════════════════"
